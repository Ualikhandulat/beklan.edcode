    ...
    <form method="POST" action="{{ $action }}">
        ...
        <div class="card mb-4">
            <div class="flex items-center justify-between mb-4">
                <p class="q-section-label !mb-0">Кому выдать доступ</p>
            </div>
        ...
        {{-- ── 3. ЕНТ конфигурация ─────────────────────────────────────────── --}}
        <div x-show="accessType === 'ent'" x-cloak class="space-y-4 mb-4">
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <label class="inline-flex items-center gap-2.5 cursor-pointer">
                        ...
                        <div class="relative shrink-0">
                            ...
                            <div class="w-11 h-6 bg-gray-200 peer-checked:bg-success rounded-full transition-all shadow-inner border border-gray-200 peer-focus:ring-2 peer-focus:ring-success/30"></div>
        ...
        <div x-show="accessType === 'subject'" x-cloak class="space-y-4 mb-4">
            <div class="card">
                ...
                <div x-show="single.partType !== ''" x-cloak class="space-y-3">
                    ...
                    <label class="inline-flex items-center gap-3 cursor-pointer">
                        <div class="relative shrink-0">
                            ...
                            <div class="w-9 h-5 bg-gray-200 peer-checked:bg-success rounded-full transition-all shadow-inner border border-gray-200"></div>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.test-accesses.index') }}" class="btn btn-outline">Отмена</a>
        </div>
